...
class PreferencesPanels extends Node {
  ...
  constructor( preferencesConfiguration, supportedTabs, selectedTabProperty, simSoundProperty, preferencesProperties ) {
    super();
    ...
    if ( supportedTabs.includes( PreferencesDialog.PreferencesTab.AUDIO ) ) {
      audioPreferencesPanel = new AudioPreferencesPanel( preferencesConfiguration.audioOptions, simSoundProperty, preferencesProperties.toolbarEnabledProperty );
