...
class ScreenView extends Node {
  ...
  /**
   * Default layout function uses the width and height of the view bounds to scale the content (based on whichever is
   * more limiting: width or height) and centers the content within the provided bounds.
   *
